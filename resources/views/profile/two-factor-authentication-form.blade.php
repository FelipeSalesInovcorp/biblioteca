<x-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-3 max-w-xl text-sm text-gray-600">
            <p>
                {{ __('Quando a autenticação de dois fatores está ativada, você será solicitado a inserir um token aleatório e seguro durante o processo de autenticação. Você pode obter esse token no aplicativo Google Authenticator do seu telefone.') }}
            </p>
        </div>
