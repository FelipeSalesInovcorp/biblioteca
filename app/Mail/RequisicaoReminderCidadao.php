...
class RequisicaoReminderCidadao extends Mailable
{
    ...
    public function build()
    {
        ...
        $mail = $this->subject('Lembrete: entrega amanhã da Requisição #'.$this->requisicao->numero_sequencial)
            ->markdown('emails.requisicoes.reminder_cidadao', [
